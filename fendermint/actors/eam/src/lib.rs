...
pub enum ExtraMethods {
    UpdateDeployers = recall_frc42_dispatch::method_hash!("UpdateDeployers"),
}
...
mod tests {
    ...
    use recall_fil_actor_eam::{
        compute_address_create, CreateExternalParams, CreateParams, Return,
    };
