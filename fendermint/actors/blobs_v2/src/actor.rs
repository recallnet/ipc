...
use fendermint_actor_blobs_v2_shared::params::{
...
use fendermint_actor_blobs_v2_shared::Method;
use fendermint_actor_recall_config_v2_shared::{get_config, require_caller_is_admin};
...
mod tests {
    ...
    use fendermint_actor_blobs_v2_shared::state::SubscriptionId;
    use fendermint_actor_blobs_v2_testing::{new_hash, new_pk};
    use fendermint_actor_recall_config_v2_shared::{RecallConfig, RECALL_CONFIG_ACTOR_ADDR};
    ...
    fn expect_get_config(rt: &MockRuntime) {
        rt.expect_send(
            ...
            fendermint_actor_recall_config_v2_shared::Method::GetConfig as MethodNum,
            None,
            TokenAmount::zero(),
            None,
            SendFlags::READ_ONLY,
