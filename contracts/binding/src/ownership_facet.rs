...
pub mod ownership_facet {
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15`\x0FW`\0\x80\xFD[Pa\x02!\x80a\0\x1F`\09`\0\xF3\xFE`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[P`\x046\x10a\x006W`\x005`\xE0\x1C\x80c\x8D\xA5\xCB[\x14a\0;W\x80c\xF2\xFD\xE3\x8B\x14a\0_W[`\0\x80\xFD[a\0Ca\0tV[`@Q`\x01`\x01`\xA0\x1B\x03\x90\x91\x16\x81R` \x01`@Q\x80\x91\x03\x90\xF3[a\0ra\0m6`\x04a\x01\xBBV[a\0\xACV[\0[`\0a\0\xA7\x7F\x80n\x0C\xBB\x9F\xCE)k\xBC3jH\xF4+\xF1\xDB\xC6\x97\"\xD1\x8D\x90\xD6\xFEp[u\x82\xC2\xBBK\xD5T`\x01`\x01`\xA0\x1B\x03\x16\x90V[\x90P\x90V[a\0\xB5\x81a\0\xB8V[PV[\x7F\x80n\x0C\xBB\x9F\xCE)k\xBC3jH\xF4+\xF1\xDB\xC6\x97\"\xD1\x8D\x90\xD6\xFEp[u\x82\xC2\xBBK\xD2`\x03\x01T`\x01`\x01`\xA0\x1B\x03\x163\x14a\x01\x05W`@Qc0\xCDtq`\xE0\x1B\x81R`\x04\x01`@Q\x80\x91\x03\x90\xFD[`\x01`\x01`\xA0\x1B\x03\x81\x16a\x01,W`@Qc\xE6\xC4${`\xE0\x1B\x81R`\x04\x01`@Q\x80\x91\x03\x90\xFD[a\0\xB5\x81`\0\x7F\x80n\x0C\xBB\x9F\xCE)k\xBC3jH\xF4+\xF1\xDB\xC6\x97\"\xD1\x8D\x90\xD6\xFEp[u\x82\xC2\xBBK\xD2`\x03\x81\x01\x80T`\x01`\x01`\xA0\x1B\x03\x19\x81\x16`\x01`\x01`\xA0\x1B\x03\x86\x81\x16\x91\x82\x17\x90\x93U`@\x80Q\x93\x90\x92\x16\x80\x84R` \x84\x01\x91\x90\x91R\x92\x93P\x7F\x8B\xE0\x07\x9CS\x16Y\x14\x13D\xCD\x1F\xD0\xA4\xF2\x84\x19I\x7F\x97\"\xA3\xDA\xAF\xE3\xB4\x18okdW\xE0\x91\x01`@Q\x80\x91\x03\x90\xA1PPPV[`\0` \x82\x84\x03\x12\x15a\x01\xCDW`\0\x80\xFD[\x815`\x01`\x01`\xA0\x1B\x03\x81\x16\x81\x14a\x01\xE4W`\0\x80\xFD[\x93\x92PPPV\xFE\xA2dipfsX\"\x12 C\x0E\x1CE6h\x899\xDCO\xF2?\xEE\x8E\xF4\xEE\xE8\x1AN\xAD\xEB;eTA2\xC6Z\x8F)\xBC\xD3dsolcC\0\x08\x1A\x003";
    ...
    impl ::ethers::core::abi::AbiDecode for OwnershipFacetErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for OwnershipFacetErrors {
    ...
    impl ::ethers::contract::ContractRevert for OwnershipFacetErrors {
    ...
    impl ::core::fmt::Display for OwnershipFacetErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for OwnershipFacetErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<InvalidAddress> for OwnershipFacetErrors {
        fn from(value: InvalidAddress) -> Self {
            Self::InvalidAddress(value)
        }
    }
    impl ::core::convert::From<NotOwner> for OwnershipFacetErrors {
