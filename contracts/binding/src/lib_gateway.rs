...
pub mod lib_gateway {
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80\x80`@R4`\x17W`:\x90\x81`\x1D\x8290\x81PP\xF3[`\0\x80\xFD\xFE`\0\x80\xFD\xFE\xA2dipfsX\"\x12 5\x1D\xEF\x96\xB9\xBB\xCD\x18v7\x96\xD6/\xCD\xDB\x0E-ip]\x88 \xB2-\x86\xDD\xB7\xD1\x0B$\xD2\xBEdsolcC\0\x08\x1A\x003";
    /// The bytecode of the contract.
    pub static LIBGATEWAY_BYTECODE: ::ethers::core::types::Bytes =
        ::ethers::core::types::Bytes::from_static(__BYTECODE);
    #[rustfmt::skip]
    const __DEPLOYED_BYTECODE: &[u8] = b"`\0\x80\xFD\xFE\xA2dipfsX\"\x12 5\x1D\xEF\x96\xB9\xBB\xCD\x18v7\x96\xD6/\xCD\xDB\x0E-ip]\x88 \xB2-\x86\xDD\xB7\xD1\x0B$\xD2\xBEdsolcC\0\x08\x1A\x003";
