...
pub mod subnet_actor_getter_facet {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("getTotalConfirmedStorage"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
                                "getTotalConfirmedStorage",
                            ),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                ...
                (
                    ::std::borrow::ToOwned::to_owned("tokensPerStorageRatio"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
                                "tokensPerStorageRatio",
                            ),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
    ...
    impl<M: ::ethers::providers::Middleware> SubnetActorGetterFacet<M> {
        ...
        ///Calls the contract's `crossMsgsHash` (0xe02d971b) function
        pub fn cross_msgs_hash(
            &self,
            messages: ::std::vec::Vec<IpcEnvelope>,
        ) -> ::ethers::contract::builders::ContractCall<M, [u8; 32]> {
            self.0
                .method_hash([224, 45, 151, 27], messages)
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `tokensPerStorageRatio` (0xb42c905b) function
        pub fn tokens_per_storage_ratio(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ::ethers::core::types::U256> {
            self.0
                .method_hash([180, 44, 144, 91], ())
                .expect("method not found (this should never happen)")
        }
    }
    ...
    ///Container type for all input parameters for the `crossMsgsHash` function with signature `crossMsgsHash((uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[])` and selector `0xe02d971b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "crossMsgsHash",
        abi = "crossMsgsHash((uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[])"
    )]
    ...
    ///Container type for all input parameters for the `tokensPerStorageRatio` function with signature `tokensPerStorageRatio()` and selector `0xb42c905b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "tokensPerStorageRatio", abi = "tokensPerStorageRatio()")]
    pub struct TokensPerStorageRatioCall;
    ...
    pub enum SubnetActorGetterFacetCalls {
        ...
        TokensPerStorageRatio(TokensPerStorageRatioCall),
    }
    impl ::ethers::core::abi::AbiDecode for SubnetActorGetterFacetCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <TokensPerStorageRatioCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TokensPerStorageRatio(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for SubnetActorGetterFacetCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::TokensPerStorageRatio(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
            }
        }
    ...
    impl ::core::fmt::Display for SubnetActorGetterFacetCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::TokensPerStorageRatio(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    impl ::core::convert::From<TokensPerStorageRatioCall> for SubnetActorGetterFacetCalls {
        fn from(value: TokensPerStorageRatioCall) -> Self {
            Self::TokensPerStorageRatio(value)
        }
    }
    ...
    ///Container type for all return fields from the `crossMsgsHash` function with signature `crossMsgsHash((uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[])` and selector `0xe02d971b`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `tokensPerStorageRatio` function with signature `tokensPerStorageRatio()` and selector `0xb42c905b`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct TokensPerStorageRatioReturn {
