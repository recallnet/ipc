const LIBMAP = {
    AccountHelper: process.env.ACCOUNT_HELPER,
    SubnetIDHelper: process.env.SUBNET_ID_HELPER,
    CrossMsgHelper: process.env.CROSS_MSG_HELPER,
    LibStaking: process.env.LIB_STAKING,
    LibQuorum: process.env.LIB_QUORUM
};
